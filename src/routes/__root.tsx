  ...
  head: () => ({
    meta: [
      ...
      { title: "SAFESKY — AI Emergency Response Drone" },
      {
        name: "description",
        content:
          "SAFESKY sends instant SOS alerts, shares live GPS, and links responders to AI drone monitoring.",
      },
      { name: "author", content: "SAFESKY" },
      { property: "og:title", content: "SAFESKY — AI Emergency Response Drone" },
      {
        property: "og:description",
        content: "Instant SOS alerts, live GPS tracking and AI drone response for women and children.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "SAFESKY" },
    ],
    links: [
      {
        rel: "stylesheet",
